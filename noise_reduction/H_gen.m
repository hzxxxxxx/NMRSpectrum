...
%         if     c1<=16000
%                 datapath1='E:\数据集\Data1D-H\training_good/';
%                 FileName1=['pure',num2str(c1),'.txt'];
%                 dlmwrite(strcat(datapath1,FileName1), pure1,'delimiter' , ' ', 'precision', '%.15f', 'newline', 'pc');
%                 datapath2='E:\数据集\Data1D-H\training/';
%                 FileName2=['impure',num2str(c1),'.txt'];
%                 dlmwrite(strcat(datapath2,FileName2), impure1,'delimiter' , ' ', 'precision', '%.15f', 'newline', 'pc');                
%                                
%         elseif c1>16000&&c1<=18000        
%                 datapath1='E:\数据集\Data1D-H\validation_good/';
%                 FileName1=['pure',num2str(c1),'.txt'];
%                 dlmwrite(strcat(datapath1,FileName1), pure1,'delimiter' , ' ', 'precision', '%.15f', 'newline', 'pc');
%                 datapath2='E:\数据集\Data1D-H\validation/';
%                 FileName2=['impure',num2str(c1),'.txt'];
%                 dlmwrite(strcat(datapath2,FileName2), impure1,'delimiter' , ' ', 'precision', '%.15f', 'newline', 'pc'); 
%                 
%                 
%         elseif     c1<=20000    
%                 datapath1='E:\数据集\Data1D-H\testing_good/';
%                 FileName1=['pure',num2str(c1),'.txt'];
%                 dlmwrite(strcat(datapath1,FileName1), pure1,'delimiter' , ' ', 'precision', '%.15f', 'newline', 'pc');
%                 datapath2='E:\数据集\Data1D-H\testing/';
%                 FileName2=['impure',num2str(c1),'.txt'];
%                 dlmwrite(strcat(datapath2,FileName2), impure1,'delimiter' , ' ', 'precision', '%.15f', 'newline', 'pc'); 
%                 
%          end
...
data=struct('data_x',spec_X);
save('data_pure.mat','data');
data=struct('data_y',spec_Y);
save('data_impure.mat','data');